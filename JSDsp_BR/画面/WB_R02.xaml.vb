Public Class WB_R02
    ...
    Private Sub 初期化()
        ...
        'タイトル　　　TB_RED_1_2_Title
        CType(FindName("TB_RED_1_1_Title"), TextBox).Opacity = 0
        CType(FindName("TB_RED_1_2_Title"), TextBox).Opacity = 0
        CType(FindName("TB_RED_1_3_Title"), TextBox).Opacity = 0
        CType(FindName("TB_RED_1_4_Title"), TextBox).Opacity = 0
        CType(FindName("TB_RED_1_5_Title"), TextBox).Opacity = 0
        CType(FindName("TB_RED_1_6_Title"), TextBox).Opacity = 0

        CType(FindName("TB_RED_2_1_Title"), TextBox).Opacity = 0
        CType(FindName("TB_RED_2_2_Title"), TextBox).Opacity = 0
        CType(FindName("TB_RED_2_3_Title"), TextBox).Opacity = 0
        CType(FindName("TB_RED_2_4_Title"), TextBox).Opacity = 0
        CType(FindName("TB_RED_2_5_Title"), TextBox).Opacity = 0
        CType(FindName("TB_RED_2_6_Title"), TextBox).Opacity = 0
        ...
        CType(FindName("TB_RED_1_16"), TextBox).Opacity = 0
        ...
        CType(FindName("TB_RED_2_16"), TextBox).Opacity = 0
        ...
        CType(FindName("TB_RED_1_26"), TextBox).Opacity = 0
        ...
        CType(FindName("TB_RED_2_26"), TextBox).Opacity = 0
        ...
        CType(FindName("TB_RED_1_36"), TextBox).Opacity = 0
        ...
        CType(FindName("TB_RED_2_36"), TextBox).Opacity = 0
    ...
    End Sub
    Public Sub No00(FadeFlag_ As Boolean)
        ...
        If FadeFlag = True Then
            ...
            フェードイン(CType(FindName("TB_RED_1_1_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_1_2_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_1_3_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_1_4_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_1_5_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_1_6_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_2_1_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_2_2_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_2_3_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_2_4_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_2_5_Title"), TextBox), sb, 1750)
            フェードイン(CType(FindName("TB_RED_2_6_Title"), TextBox), sb, 1750)

        Else

            フェードイン(CType(FindName("LB_選手名_赤"), Label), sb, 0)
            フェードイン(CType(FindName("LB_選手名_青"), Label), sb, 0)
            フェードイン(CType(FindName("LB_所属名_赤"), Label), sb, 0)
            フェードイン(CType(FindName("LB_所属名_青"), Label), sb, 0)

            フェードイン(CType(FindName("選手イメージ_赤"), Image), sb, 0)
            フェードイン(CType(FindName("選手イメージ_青"), Image), sb, 0)


            フェードイン(CType(FindName("LB_PCS_T00"), Label), sb, 0)
            フェードイン(CType(FindName("LB_PCS_T01"), Label), sb, 0)
            フェードイン(CType(FindName("LB_PCS_T02"), Label), sb, 0)
            フェードイン(CType(FindName("LB_PCS_T03"), Label), sb, 0)
            フェードイン(CType(FindName("LB_PCS_T04"), Label), sb, 0)

            フェードイン(CType(FindName("LB_VS"), Label), sb, 0)

            フェードイン(CType(FindName("TB_RED_1_1_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_1_2_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_1_3_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_1_4_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_1_5_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_1_6_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_2_1_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_2_2_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_2_3_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_2_4_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_2_5_Title"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_RED_2_6_Title"), TextBox), sb, 0)
    ...
    Public Sub No01(FadeFlag_ As Boolean)
        ...
        For p = 1 To 4
            ...
            Else
                フェードイン(CType(FindName("TB_PCS_2" & p), TextBox), sb, 0)
            End If
        Next p
        ...
        For s = 1 To 2
            For d = 1 To 6
                ...
                Else
                    フェードイン(CType(FindName("TB_RED_" & s & "_1" & d), TextBox), sb, 0)
                End If
            Next d
        Next s
        ...
        For s = 1 To 2
            For d = 1 To 6
                If FadeFlag = True Then
                    フェードイン(CType(FindName("TB_RED_" & s & "_2" & d), TextBox), sb, 750)
                Else
                    フェードイン(CType(FindName("TB_RED_" & s & "_2" & d), TextBox), sb, 0)
                End If
            Next d
        Next s
        ...
        If FadeFlag = True Then
            ...
            '結果
            フェードイン(CType(FindName("TB_POINT_1_1"), TextBox), sb, 1500)
            フェードイン(CType(FindName("TB_POINT_2_1"), TextBox), sb, 1500)
            フェードイン(CType(FindName("LB_R1"), Label), sb, 1000)


            '結果
            フェードイン(CType(FindName("TB_POINT_1_2"), TextBox), sb, 2000)
            フェードイン(CType(FindName("TB_POINT_2_2"), TextBox), sb, 2000)
            フェードイン(CType(FindName("LB_R2"), Label), sb, 1000)


            'total結果
            フェードイン(CType(FindName("TB_POINT_1_Total"), TextBox), sb, 2500)
            フェードイン(CType(FindName("TB_POINT_2_Total"), TextBox), sb, 2500)
            フェードイン(CType(FindName("LB_Total"), Label), sb, 2000)


            'WINNER
            フェードイン(CType(FindName("LB_WINNER"), Label), sb, 3000)
            フェードイン(CType(FindName("IMG_WINNER"), Image), sb, 3000)
            フェードイン(CType(FindName("LB_勝者名"), Label), sb, 3250)

        Else

            フェードイン(CType(FindName("LB_PCS_R2"), Label), sb, 0)
            フェードイン(CType(FindName("LB_RED_R2"), Label), sb, 0)

            '結果
            フェードイン(CType(FindName("TB_POINT_1_1"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_POINT_2_1"), TextBox), sb, 0)
            フェードイン(CType(FindName("LB_R1"), Label), sb, 0)


            '結果
            フェードイン(CType(FindName("TB_POINT_1_2"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_POINT_2_2"), TextBox), sb, 0)
            フェードイン(CType(FindName("LB_R2"), Label), sb, 0)


            'total結果
            フェードイン(CType(FindName("TB_POINT_1_Total"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_POINT_2_Total"), TextBox), sb, 0)
            フェードイン(CType(FindName("LB_Total"), Label), sb, 0)


            'WINNER
            フェードイン(CType(FindName("LB_WINNER"), Label), sb, 0)
            フェードイン(CType(FindName("IMG_WINNER"), Image), sb, 0)
            フェードイン(CType(FindName("LB_勝者名"), Label), sb, 0)
    ...
    Public Sub No03(FadeFlag_ As Boolean)
    ...
    Public Sub No02(FadeFlag_ As Boolean)
        ...
        For s = 1 To 2
            For d = 1 To 6
                ...
                Else
                    フェードイン(CType(FindName("TB_RED_" & s & "_3" & d), TextBox), sb, 0)
                End If
            Next d
        Next s
        ...
        Else
            ...
            '結果
            フェードイン(CType(FindName("TB_POINT_1_3"), TextBox), sb, 0)
            フェードイン(CType(FindName("TB_POINT_2_3"), TextBox), sb, 0)
            フェードイン(CType(FindName("LB_R3"), Label), sb, 0)
    ...
    Public Sub 全フェードアウト(FadeFlag As Boolean)
        ...
        For s = 1 To 2
            For r = 1 To 3
                For d = 1 To 6
                    フェードアウト(CType(FindName("TB_RED_" & s & "_" & d & "_Title"), TextBox), sb, 0)
                    フェードアウト(CType(FindName("TB_RED_" & s & "_" & r & d), TextBox), sb, 0)
                Next d
            Next r
        Next s
    ...
    Public Function データセット(バトル結果 As SC_B_Result_C)
        ...
        Try
            ...
            For s = 1 To 2
                For d = 1 To 6
                    CType(FindName("TB_RED_" & s & "_" & d & "_Title"), TextBox).Text = バトル結果.SC_BR_B_Result_選手(s).SC_BR_B_Result_選手_ラウンド結果(1 + (画面番号 - 1) * 3).SC_BR_B_Result_選手_ラウンド結果_減点(d).減点項目名
    ...
    Private Sub TB_PCS設定(TB名 As String, 赤得点 As Decimal, 青得点 As Decimal)
        ...
        Else
            '同点の時
            CType(FindName(TB名), TextBox).Text = "0.0%"
            CType(FindName(TB名), TextBox).Foreground = Brushes.DimGray
            'CType(FindName(TB名), TextBox).Background = Brushes.YellowGreen
            CType(FindName(TB名), TextBox).Background = Brushes.White
        End If
        ...
        If obj IsNot Nothing Then
            ...
            If obj.opacity <> 0 Then '元々消えていたらフェードアウトしない
                ...
                Else
                    ...
                    FadeInAnimation.Duration = New Duration(New TimeSpan(0, 0, 0, 0, 100))
                    FadeInAnimation.BeginTime = TimeSpan.FromMilliseconds(Begintime)
